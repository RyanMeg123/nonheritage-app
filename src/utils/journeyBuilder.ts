...
export function buildProfileData(plan: CraftPlanData): ProfileScreenData {
  return {
    ...
    stageValue: '打样准备中',
    nextNodeLabel: '下一节点',
    nextNodeValue: '查看打样反馈并确认是否继续调整',
    currentActionLabel: '当前待你处理',
    currentActionTitle: '确认本轮版本是否可以直接进入打样',
    currentActionSummary: `现在最该看的不是历史信息，而是确认 ${plan.title} 这版是否保持当前方向继续推进。`,
    currentActionChecklist: [
      '先看最新版本是否保留你想要的整体气质。',
      '确认袖口和细节层次是否还需要继续收轻。',
      '如果没有新的修改点，就按当前版本进入打样。',
    ],
    currentActionOutcome: '确认后，系统会继续推进打样反馈，不会再回到开放式需求整理。',
    versionTitle: '最近版本更新',
    versionTag: 'V2',
    versionSummary: '最新一次更新把袖口层次继续收轻，当前版本已进入打样准备。',
    versionNote: '这是本轮推进的基准版本，后面的打样和反馈都会围绕这一版展开。',
    orderTitle: '当前订单',
    orderSummary: '确认单、参考价格区间和最新推进状态都已收在当前项目里，后续不会跳回开放式需求。',
    orderTag: '进行中',
    messageTitle: '最近消息',
    messageSummary: '最新一轮沟通主要在确认当前版本能否直接进入打样，以及是否还需要补充一轮细节调整。',
    messageTag: '刚收到',
    messageActionLabel: '优先看本轮沟通',
    historyTitle: '历史版本',
    historySummary: '已经形成记录的版本会沉淀在这里，方便你回看每一轮是怎么推进过来的。',
    historyItems: [
      {
        id: 'history-v2',
        version: 'V2',
        title: '袖口层次继续收轻',
        summary: '当前生效版本，已进入打样准备。',
        state: 'current',
      },
      {
        id: 'history-v1',
    ...
    accountTitle: '账户与服务',
    accountSummary: '这些入口主要是辅助使用，不参与当前项目推进。',
    accountItems: [
      {
        id: 'account-1',
        title: '我的确认单',
